...
1. [여기](https://github.com/kaguyachiro/timebackground/releases/latest/download/app-release.apk)(다운로드 링크)를 클릭합니다.
2. 다운로드한 APK 파일을 실행하여 설치합니다. *(※ 출처를 알 수 없는 앱 설치 허용 필요)*
